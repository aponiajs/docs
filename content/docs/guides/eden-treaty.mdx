...
See [native Elysia access](/docs/guides/native-elysia-access),
[plugin modules](/docs/guides/elysia-plugin-modules), and
[in-process requests](/docs/guides/in-process-requests).
